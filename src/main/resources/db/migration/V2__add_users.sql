...
INSERT INTO system_users (username, password) VALUES ('customer', '$2a$10$eWUuFVfcU51cFz/Fo/S/p.VooS2mr3za/ZQVhmQ.7Q1iq2vFgbZ9e');
...
INSERT INTO user_roles (user_id, role_id) VALUES ((SELECT id FROM system_users WHERE username = 'customer'), (SELECT id FROM roles WHERE name = 'ROLE_CUSTOMER'));